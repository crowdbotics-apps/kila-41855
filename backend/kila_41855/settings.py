"""
Django settings for kila_41855 project.
...
WSGI_APPLICATION = 'kila_41855.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kila_41855 API",
    "DESCRIPTION": "API documentation for kila_41855 App",
    "VERSION": "v1",
}
